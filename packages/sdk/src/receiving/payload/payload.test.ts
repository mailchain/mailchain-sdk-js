	...
	const tests: TestDetails[] = [
		{
			...
			initMock: () => {
				...
				mockPayloadOriginVerifier.verifyPayloadOrigin.mockResolvedValue();
			},
		...
		},
		{
			...
			initMock: () => {
				...
				mockPayloadOriginVerifier.verifyPayloadOrigin.mockRejectedValue(new ErrorPayloadSignatureInvalid());
			},
			payloadRootEncryptionKey: ED25519ExtendedPrivateKey.fromPrivateKey(
				ED25519PrivateKey.fromSecretKey(
					Uint8Array.from([
