...
$root.protocol = (function () {
	...
	protocol.ECDHKeyBundle = (function () {
		 ...
		 * @property {Uint8Array|null} [publicIdentityKey] ECDHKeyBundle publicIdentityKey
		 */
		 ...
		 * @instance
		 */
		ECDHKeyBundle.prototype.publicIdentityKey = $util.newBuffer([]);
		...
		ECDHKeyBundle.verify = function verify(message) {
			...
			if (message.publicIdentityKey !== null && message.hasOwnProperty('publicIdentityKey'))
				if (
					!(
						(message.publicIdentityKey && typeof message.publicIdentityKey.length === 'number') ||
						$util.isString(message.publicIdentityKey)
					)
				)
			...
			if (object.publicIdentityKey !== null)
				if (typeof object.publicIdentityKey === 'string')
					$util.base64.decode(
						...
						(message.publicIdentityKey = $util.newBuffer($util.base64.length(object.publicIdentityKey))),
						0,
					);
				else if (object.publicIdentityKey.length) message.publicIdentityKey = object.publicIdentityKey;
			return message;
		};
		...
		ECDHKeyBundle.toObject = function toObject(message, options) {
			...
			if (options.defaults) {
				...
				if (options.bytes === String) object.publicIdentityKey = '';
				else {
					object.publicIdentityKey = [];
					if (options.bytes !== Array) object.publicIdentityKey = $util.newBuffer(object.publicIdentityKey);
				}
			}
			if (message.publicEphemeralKey !== null && message.hasOwnProperty('publicEphemeralKey'))
				object.publicEphemeralKey =
			...
			if (message.publicIdentityKey !== null && message.hasOwnProperty('publicIdentityKey'))
				object.publicIdentityKey =
					options.bytes === String
						? $util.base64.encode(message.publicIdentityKey, 0, message.publicIdentityKey.length)
						: options.bytes === Array
						? Array.prototype.slice.call(message.publicIdentityKey)
						: message.publicIdentityKey;
			return object;
		};
	...
	protocol.X3DHKeyBundle = (function () {
		 ...
		 * @property {Uint8Array|null} [publicIdentityKey] X3DHKeyBundle publicIdentityKey
		 */
		 ...
		 * @instance
		 */
		X3DHKeyBundle.prototype.publicIdentityKey = $util.newBuffer([]);
	...
	protocol.Delivery = (function () {
		 ...
		 * @property {Uint8Array|null} [destinationIdentity] Public key associated with the delivery address. When sending a message to an address
		 ...
		 * note multiple addresses may resolve
		 * to the same public key.
		 * @member {Uint8Array} destinationIdentity
		 * @memberof protocol.Delivery
		 * @instance
		 */
		Delivery.prototype.destinationIdentity = $util.newBuffer([]);
		...
		Delivery.encode = function encode(message, writer) {
			...
			if (message.destinationIdentity !== null && Object.hasOwnProperty.call(message, 'destinationIdentity'))
				writer.uint32(/* id 2, wireType 2 =*/ 18).bytes(message.destinationIdentity);
			return writer;
		};
			...
			while (reader.pos < end) {
				...
				switch (tag >>> 3) {
					case 1:
						...
						break;
					case 2:
						message.destinationIdentity = reader.bytes();
						break;
					default:
						reader.skipType(tag & 7);
						break;
		...
		Delivery.verify = function verify(message) {
			...
			if (message.destinationIdentity !== null && message.hasOwnProperty('destinationIdentity'))
				if (
					!(
						(message.destinationIdentity && typeof message.destinationIdentity.length === 'number') ||
						$util.isString(message.destinationIdentity)
					)
				)
					return 'destinationIdentity: buffer expected';
			return null;
		};
		...
		Delivery.fromObject = function fromObject(object) {
			...
			if (object.destinationIdentity !== null)
				if (typeof object.destinationIdentity === 'string')
					$util.base64.decode(
						object.destinationIdentity,
						(message.destinationIdentity = $util.newBuffer(
							$util.base64.length(object.destinationIdentity),
						)),
						0,
					);
				else if (object.destinationIdentity.length) message.destinationIdentity = object.destinationIdentity;
			return message;
		};
		...
		Delivery.toObject = function toObject(message, options) {
			...
			if (options.defaults) {
				...
				if (options.bytes === String) object.destinationIdentity = '';
				else {
					object.destinationIdentity = [];
					if (options.bytes !== Array)
						object.destinationIdentity = $util.newBuffer(object.destinationIdentity);
				}
			}
			if (message.envelope !== null && message.hasOwnProperty('envelope'))
			...
			if (message.destinationIdentity !== null && message.hasOwnProperty('destinationIdentity'))
				object.destinationIdentity =
					options.bytes === String
						? $util.base64.encode(message.destinationIdentity, 0, message.destinationIdentity.length)
						: options.bytes === Array
						? Array.prototype.slice.call(message.destinationIdentity)
