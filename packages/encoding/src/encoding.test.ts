...
describe('Encode', () => {
	const tests = [
		...
		},
		{
			...
			expected: 'bgdmm4kdvwlg7jlzzentbrt7sxtuxthdyxwlsxewx62yfb3fmtsjycb7dq',
			shouldThrow: false,
		},
		{
			name: 'base58',
...
describe('Decode', () => {
	const tests = [
		...
		},
		{
			name: 'base32',
			encoding: EncodingTypes.Base32,
			input: 'bgdmm4kdvwlg7jlzzentbrt7sxtuxthdyxwlsxewx62yfb3fmtsjycb7dq',
			expected: new Uint8Array([
				0x9, 0x86, 0xc6, 0x71, 0x43, 0xad, 0x96, 0x6f, 0xa5, 0x79, 0xc9, 0x1b, 0x30, 0xc6, 0x7f, 0x95, 0xe7,
				0x4b, 0xcc, 0xe3, 0xc5, 0xec, 0xb9, 0x5c, 0x96, 0xbf, 0xb5, 0x82, 0x87, 0x65, 0x64, 0xe4, 0x9c, 0x8,
				0x3f, 0x1c,
