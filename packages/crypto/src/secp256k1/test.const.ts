...
export const BobUncompressedSECP256K1PublicKeyBytes = DecodeHex(BobHexSECP256K1PublicKey);
...
export const AliceUncompressedSECP256K1PublicKeyBytes = DecodeHex(AliceHexSECP256K1PublicKey);
...
export const BobSECP256K1PrivateKeyBytes = DecodeHex(BobHexSECP256K1PrivateKey);
...
export const AliceSECP256K1PrivateKeyBytes = DecodeHex(AliceSECP256K1HexPrivateKey);
