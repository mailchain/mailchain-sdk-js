...
export namespace protocol {
    ...
    interface IECDHKeyBundle {
        ...
        publicMessagingKey?: (Uint8Array|null);
    }
    ...
    class ECDHKeyBundle implements IECDHKeyBundle {
        ...
        /** ECDHKeyBundle publicMessagingKey. */
        public publicMessagingKey: Uint8Array;
         ...
         */
        public static toObject(message: protocol.ECDHKeyBundle, options?: $protobuf.IConversionOptions): { [k: string]: any };
    ...
    class X3DHKeyBundle implements IX3DHKeyBundle {
         ...
         * @returns Plain object
         */
        public static toObject(message: protocol.X3DHKeyBundle, options?: $protobuf.IConversionOptions): { [k: string]: any };
    ...
    class Envelope implements IEnvelope {
         ...
         * @returns Plain object
         */
        public static toObject(message: protocol.Envelope, options?: $protobuf.IConversionOptions): { [k: string]: any };
    ...
    class Delivery implements IDelivery {
         ...
         * @returns Plain object
         */
        public static toObject(message: protocol.Delivery, options?: $protobuf.IConversionOptions): { [k: string]: any };
