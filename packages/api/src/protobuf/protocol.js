...
$root.protocol = (function() {
    ...
    protocol.ECDHKeyBundle = (function() {
        ...
        ECDHKeyBundle.decode = function decode(reader, length) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.ECDHKeyBundle();
        ...
        ECDHKeyBundle.fromObject = function fromObject(object) {
            ...
            if (object.publicEphemeralKey != null)
                ...
                else if (object.publicEphemeralKey.length)
            ...
            if (object.publicMessagingKey != null)
                ...
                else if (object.publicMessagingKey.length)
    ...
    protocol.X3DHKeyBundle = (function() {
        ...
        X3DHKeyBundle.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.X3DHKeyBundle();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        X3DHKeyBundle.toObject = function toObject(message, options) {
            ...
            if (message.keyExchangeMethod != null && message.hasOwnProperty("keyExchangeMethod"))
                object.keyExchangeMethod = options.enums === String ? $root.protocol.KeyExchangeMethod[message.keyExchangeMethod] : message.keyExchangeMethod;
            if (message.publicMessagingKey != null && message.hasOwnProperty("publicMessagingKey"))
                object.publicMessagingKey = options.bytes === String ? $util.base64.encode(message.publicMessagingKey, 0, message.publicMessagingKey.length) : options.bytes === Array ? Array.prototype.slice.call(message.publicMessagingKey) : message.publicMessagingKey;
            return object;
        };
    ...
    protocol.Envelope = (function() {
        ...
        Envelope.encode = function encode(message, writer) {
            ...
            if (message.ecdhKeyBundle != null && Object.hasOwnProperty.call(message, "ecdhKeyBundle"))
                $root.protocol.ECDHKeyBundle.encode(message.ecdhKeyBundle, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            return writer;
        };
        ...
        Envelope.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.Envelope();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Envelope.fromObject = function fromObject(object) {
            ...
            if (object.encryptedMessageKey != null)
                ...
                else if (object.encryptedMessageKey.length)
            ...
            if (object.encryptedMessageUri != null)
                ...
                else if (object.encryptedMessageUri.length)
    ...
    protocol.Delivery = (function() {
        ...
        Delivery.encode = function encode(message, writer) {
            ...
            if (message.envelope != null && Object.hasOwnProperty.call(message, "envelope"))
                $root.protocol.Envelope.encode(message.envelope, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            return writer;
        };
        ...
        Delivery.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.Delivery();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
