...
export const ALL_PROTOCOLS = [ALGORAND, ETHEREUM, SUBSTRATE, NEAR, MAILCHAIN, TEZOS, SOLANA] as const;
export type ProtocolType = (typeof ALL_PROTOCOLS)[number];

const ENABLED_PROTOCOLS = [ETHEREUM, NEAR, TEZOS, SOLANA] as const;
